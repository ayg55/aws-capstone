...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/ayg/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/ayg/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.cdkkccm06rde.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-ayg-blog' # please enter your s3 bucket name
